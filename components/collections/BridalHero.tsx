      ...
      <div className="relative z-20 flex h-full items-center">
        ...
        <div className="mx-auto w-full max-w-7xl px-6 lg:px-10">
          ...
          >
            ...
            <h1 className="font-heading text-5xl font-light leading-tight text-white md:text-7xl">
            ...
            <p className="mt-8 max-w-xl text-lg leading-8 text-white/80">
              ...
              Designed for life's most treasured celebrations,
              every masterpiece is handcrafted to honour love,
              legacy and timeless elegance.
